...
import user from "../Registration/user.png";
...
const SignUp = () => {
  ...
  return (
    ...
    <div className='register mt-5 col-lg-4 col-md-4 col-sm-8'>
        <form onSubmit={(e)=>submit(e)} >
            <img src={user} alt='user-logo' />
            <h3 className='user-pro text-center'>USER</h3>
            <label htmlFor='user' className='form-label'>UserName</label>
            <input className='form-control' type='text' name='username' id='user' value={userData.username} onChange={e => handleValue(e)} onBlur={formik.handleBlur}/>
            <p className='error'>{formik.touched.username && formik.errors.username ? formik.errors.username : ""}</p>

            <label htmlFor='fname' className='form-label'>First Name</label>
            <input className='form-control' type='text' name='firstName' id='fname' value={userData.firstName} onChange={e => handleValue(e)} onBlur={formik.handleBlur}/>
            <p className='error'>{formik.touched.firstName && formik.errors.firstName ? formik.errors.firstName : ""}</p>

            <label htmlFor='lname' className='form-label'>Last Name</label>
            <input className='form-control' type='text' name='lastName' id='lname' value={userData.lastName} onChange={e => handleValue(e)} onBlur={formik.handleBlur}/>

            <label htmlFor='email' className='form-label'>Email Id</label>
            <input className='form-control' type='email' name='emailId' id='email' value={userData.emailId} onChange={e => handleValue(e)} onBlur={formik.handleBlur}/>
            <p className='error'>{formik.touched.emailId && formik.errors.emailId ? formik.errors.emailId : ""}</p>

            <label htmlFor='pass' className='form-label'>Password</label>
            <input className='form-control' type='password' name='password' id='pass' value={userData.password} onChange={e => handleValue(e)} onBlur={formik.handleBlur}/>
            ...
            <input className='form-control' type='password' name='conformPassword' id='cpwd' value={userData.conformPassword} onChange={e => handleValue(e)} onBlur={formik.handleBlur}/>
